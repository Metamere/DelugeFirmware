...
public:
	...
	void displayZoomLevel(bool permanent = true, bool clear_area = true, bool centered_notification = true);
	ActionResult horizontalEncoderAction(int32_t offset) override;
	void displayScrollPos();
	void displayNumberOfBarsAndBeats(uint32_t number, uint32_t quantization, bool count_from_one,
	                                 char const* too_long_text, bool popup = true);
